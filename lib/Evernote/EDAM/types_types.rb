  ...
  module EDAM
    module Type
      ...
      module RelatedContentType
        ...
        VALUE_MAP = {1 => "NEWS_ARTICLE", 2 => "PROFILE_PERSON", 3 => "PROFILE_ORGANIZATION"}
        VALID_VALUES = Set.new([NEWS_ARTICLE, PROFILE_PERSON, PROFILE_ORGANIZATION]).freeze
      end
...
#        nextPaymentDue</dd>
#  <dt>premiumCommerceServiceNext</dt>
#    <dd>The commerce service system to use on the next renewal of a recurring
#        subscription</dd>
#  <dt>premiumServiceSKUNext</dt>
#    <dd>The next SKU to apply on the next renewal of a recurring subscription</dd>
#  <dt>currencyNext</dt>
#    <dd>The currency to use on the next renewal of a recurring subscription</dd>
#  <dt>unitPriceNext</dt>
#    <dd>The unit price to use on the next renewal of a recurring subscription</dd>
#  <dt>unitDiscountNext</dt>
#    <dd>The unit discount to use on the next renewal of a recurring subscription</dd>
#  </dl>
      class Accounting
        include ::Thrift::Struct, ::Thrift::Struct_Union
        UPLOADLIMITEND = 2
        ...
        NEXTCHARGEDATE = 24
        AVAILABLEPOINTS = 25
        PREMIUMCOMMERCESERVICENEXT = 26
        PREMIUMSERVICESKUNEXT = 27
        CURRENCYNEXT = 28
        UNITPRICENEXT = 29
        UNITDISCOUNTNEXT = 30
        ...
        FIELDS = {
          ...
          PREMIUMCOMMERCESERVICENEXT => {:type => ::Thrift::Types::STRING, :name => 'premiumCommerceServiceNext', :optional => true},
          PREMIUMSERVICESKUNEXT => {:type => ::Thrift::Types::STRING, :name => 'premiumServiceSKUNext', :optional => true},
          CURRENCYNEXT => {:type => ::Thrift::Types::STRING, :name => 'currencyNext', :optional => true},
          UNITPRICENEXT => {:type => ::Thrift::Types::I32, :name => 'unitPriceNext', :optional => true},
          UNITDISCOUNTNEXT => {:type => ::Thrift::Types::I32, :name => 'unitDiscountNext', :optional => true}
        }
...
# 
#  <dt>serviceLevel</dt>
#    <dd>The level of service the user currently receives
#    </dd>
# 
#  <dt>created</dt>
